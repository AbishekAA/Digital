...
class PDF extends FPDF{
    ...
    function Header(){
      ...
      if ($this->PageNo() == 1 ) {
        ...
        //Header Content
        $this->Image('C:\Users\abishek.prasad\Music\DIGITAL FINAL\Digital\assets\images\MH.png',0,0);
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            
                            ...
                            <li><i class="fa fa-id-badge"></i><a href="salariedcontract.php.php">Salaried Contract</a></li>
