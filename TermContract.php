...
// $pdf->Cell(34	,5,'',0,1);//end of line
$pdf->SetFont('Arial','B',11);
$pdf->Cell(40,5,'Position:','',0,'L',);$pdf->SetFont('Arial','',11);$pdf->Cell(60,5,"The position offered to you is $position ",'',0,'L');$pdf->Ln();
...
$pdf->SetFont('Arial','B',11);
$pdf->Cell(40,5,'Wage:','',0,'L');$pdf->SetFont('Arial','',11);$pdf->Cell(60,5,'Your wage will be $3.28 per hour.','',0,'L');$pdf->Ln();$pdf->Ln();
// $pdf->Cell(20,5,'','',0,'L');$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(60,5,'services unsatisfactory during this period.','',0,'L');$pdf->Ln();$pdf->Ln();
...
$pdf->SetFont('Arial','B',11);
$pdf->Cell(40,5,'Hours Of Work:','',0,'L');$pdf->SetFont('Arial','',11);$pdf->Cell(5,5,'','',0,'L');$pdf->Cell(60,5,'You will be required to work from -','',0,'L');$pdf->Ln();$pdf->Ln();
$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(60,5,'Monday - Friday	:  8.00 am to 5.00 pm','',0,'L');$pdf->Ln();$pdf->Ln();
$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(60,5,'Saturday                      :  8.00 am to 1.00 pm','',0,'L');$pdf->Ln();$pdf->Ln();
$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(60,5,'Lunch			:  1 hour','',0,'L');$pdf->Ln();$pdf->Ln();$pdf->Ln();
$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(60,5,'The nature and status of your work is such that you may be required','',0,'L');$pdf->Ln();
$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(60,5,'to work longer hours and on Saturdays, Sundays and Public Holidays','',0,'L');$pdf->Ln();
$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(60,5,'from time-to-time depending on the requirements of Management.','',0,'L');$pdf->Ln();$pdf->Ln();
...
$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(20,5,'','',0,'L');$pdf->Cell(5,5,'','',0,'L');$pdf->Cell(19,5,'','',0,'L');$pdf->SetFont('Times', '');$pdf->Cell(7,5,'II','',0,'L');$pdf->SetFont('Arial', '');$pdf->Cell(60,5,'the employee may: -','',0,'L');$pdf->Ln();
